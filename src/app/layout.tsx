    ...
    <html lang="en">
      <head>
        ...
        */}
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600&family=Space+Grotesk:wght@400;500;600;700&family=Inter:wght@400;500;600;700&family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,600;0,9..144,900;1,9..144,400;1,9..144,600&family=Nunito+Sans:wght@400;600;700&family=Nunito:wght@400;600;700;800;900&family=DM+Sans:wght@400;500;700&family=Hanken+Grotesk:wght@400;500;600;800&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
